...
getNHDGages <- function(path_to_data){
...
getGageData <- function(path_to_data, nhdGages){
  codes_huc02 <- c('01','11', '12', '13', '16')# '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16', '17', '18')
